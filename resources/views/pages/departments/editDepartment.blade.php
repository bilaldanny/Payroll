    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::model($department, ['method' => 'PATCH','url' => ['department', $department->id], 'files'=>true]) !!}
                            ...
                            <div class="p-20" style="clear: both;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::text('department_name' , null ,['class' => 'form-control','parsley-trigger' => 'change','placeholder' => 'Enter Department Name Here']) !!}
