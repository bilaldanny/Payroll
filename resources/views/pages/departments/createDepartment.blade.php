    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Create New Department</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <a class="btn btn-primary" href="{{ url('department') }}">Department List</a>
                        ...
                        <form action="{{ route('department.store') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="p-20" style="clear: both;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="department_name" parsley-trigger="change"
                                               placeholder="Enter Department Name Here" value="{{ old('department_name') }}" autocomplete="off" class="form-control"/>
