    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::model($company, ['method' => 'PATCH','url' => ['company', $company->id], 'files'=>true]) !!}
                            ...
                            <div class="p-20" style="clear: both;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        {!! Form::text('company_name' , null ,['class' => 'form-control','parsley-trigger' => 'change','placeholder' => 'Enter Company Name Here']) !!}
