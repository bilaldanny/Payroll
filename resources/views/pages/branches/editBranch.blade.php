    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card-box">
                ...
                <a class="btn btn-primary" href="{{ url('branch') }}">Branch List</a>

                <hr>

                <div class="row">
                    <div class="col-xs-12">
                        {!! Form::model($branch, ['method' => 'PATCH','url' => ['branch', $branch->id], 'files'=>true]) !!}
                        ...
                        <div class="p-20" style="clear: both;">
                            ...
                            <div class="form-group row">
                                <label for="company_name" class="col-sm-2">Branch Name<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                                    {!! Form::text('branch_name' , null ,['class' => 'form-control','parsley-trigger' => 'change','placeholder' => 'Enter Company Name Here']) !!}

                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="location" class="col-sm-2">Branch Location<span class="text-danger">*</span></label>
                                <div class="col-sm-12">
                                    {!!Form::textarea('location',null ,['class' => 'form-control','maxlength' => '200','rows' => '3', 'id' => 'textarea','placeholder' => 'Enter Company Location Here'])!!}
